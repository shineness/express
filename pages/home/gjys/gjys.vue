<template>
	<view class="service-container">
		<uv-collapse :value="[0,1,2]">
			<uv-collapse-item v-for="item,index in obj" :title="item.title" :name="index">
...
<script setup>
	const obj=[{
		...
		title:"价格模式",content:"参考价按货物重量 / 体积及目的港计算，具体需详聊。包含基本海运费、起运港本地费（如订舱费、报关费）；不含目的港杂费、关税、保险费等，特殊货物（危险品、超大件）需另计附加费。"
	}]
</script>
